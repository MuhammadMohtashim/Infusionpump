...
#define ENABLE_PIN 4         // EN pin (A4988)
#define ENDSTOP_PIN1 A5       // Endstop pin (forward movement)
#define ENDSTOP_PIN2 1       // Endstop pin (backward movement)
...
void showScreensaver()
{
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print(F("   INDUS HOSPITAL   "));
  lcd.setCursor(0, 1);
  lcd.print(F("www.indushospital.org.pk"));
  currentItem = 1;
